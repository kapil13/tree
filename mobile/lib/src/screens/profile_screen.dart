...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
              ...
              children: [
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) async {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(v ? l10n.biometricEnabled : l10n.biometricDisabled),
                          ),
                        );
                      }
                    },
                ...
                SwitchListTile(
                  ...
                  onChanged: (v) async {
                    ...
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text(v ? l10n.screenshotGuardEnabled : l10n.screenshotGuardDisabled)),
                      );
                    }
                  },
                ),
  ...
  List<Widget> _buildProgramSection(AppLocalizations l10n) {
    if (_loadingPrograms) {
      return const [
        Padding(
