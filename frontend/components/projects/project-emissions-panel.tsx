...
import { errorMessage, plantingProjects, type WorkArea } from "@/lib/api";
...
export function ProjectEmissionsPanel({
  ...
  const [plumeResult, setPlumeResult] = useState<Awaited<
    ReturnType<typeof plantingProjects.runDispersion>
  > | null>(null);
  ...
  const runMut = useMutation({
    ...
    onSuccess: (data) => setPlumeResult(data),
  });
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-stone-600">
            ...
            Open-Meteo wind data and may extend downwind outside the polygon.
          </p>
        </div>
      </div>
