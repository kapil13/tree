"""Refresh homepage CMS reports into bioacoustic and GHG grouped sections."""
...
revision = "0058_refresh_homepage_reports_groups"
down_revision = "0057_emission_fusion_assessments"
branch_labels = None
depends_on = None
