"""Refresh homepage CMS for compliance Phase B UNFCCC surfacing."""
...
revision = "0052_refresh_homepage_compliance_phase_b"
down_revision = "0051_project_safeguard_documents"
branch_labels = None
depends_on = None
