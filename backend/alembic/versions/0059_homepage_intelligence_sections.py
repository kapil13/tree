"""Refresh homepage with reports hub, biodiversity, and GHG intelligence sections."""
...
revision = "0059_homepage_intelligence_sections"
down_revision = "0058_refresh_homepage_reports_groups"
branch_labels = None
depends_on = None
