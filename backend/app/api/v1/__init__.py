...
from app.api.v1 import alerts, analysis, auth, bioacoustic, bhoonidhi, carbon, dashboard, plantation_fences, reports, satellite, satellite_health, trees, uploads, weather
