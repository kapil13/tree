...
class PlantationSatelliteRecord(UUIDPKMixin, Base):
    __tablename__ = "plantation_satellite_records"
    ...
    fence = relationship("PlantationFence", back_populates="satellite_records")

    __table_args__ = (Index("plantation_sat_fence_time_idx", "fence_id", "scene_acquired_at"),)
