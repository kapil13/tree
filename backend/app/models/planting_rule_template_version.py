"""Version history for CMS planting rule template publishes."""
...
class PlantingRuleTemplateVersion(UUIDPKMixin, Base):
    __tablename__ = "planting_rule_template_versions"
