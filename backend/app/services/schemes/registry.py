...
SCHEME_REGISTRY: dict[str, CentralSchemeDefinition] = {
    ...
    "gim_restoration": {
        ...
        "default_segment": "general",
        "default_compliance_mode": "strict",
        "default_template_code": "gim_restoration_v1",
    ...
    "mishti_mangrove": {
        ...
        "default_compliance_mode": "strict",
        "default_template_code": "mishti_mangrove_v1",
    ...
    "mgnrega_convergence": {
        ...
        "default_template_code": "mgnrega_convergence_v1",
    ...
    "jal_shakti_riparian": {
        ...
        "default_segment": "ngo_watershed",
        "default_compliance_mode": "guided",
        "default_template_code": "jal_shakti_riparian_v1",
    ...
    "green_credit_india": {
        ...
        "default_compliance_mode": "strict",
        "default_template_code": "industrial_greenbelt_v1",
    ...
    "mining_reclamation": {
        ...
        "label": "Mining Reclamation — Green Belt & Progressive Closure",
        "description": (
            "Mine lease green belts, overburden dumps, and pit rehabilitation under "
            "IBM/MMDR progressive mine closure plans with native species stocking and "
            "satellite MRV."
        ),
        "ministry": "MoM / IBM",
        "group": "corporate",
        "program_codes": ["corporate_esg"],
        "default_segment": "industrial_greenbelt",
        "default_compliance_mode": "strict",
        "default_template_code": "mining_reclamation_v1",
        "checklist_codes": ["mining_reclamation"],
        "framework_profiles": ["esg_general"],
        "convergence_allowed": ["green_credit_india", "estate_monitoring"],
        "legacy_plantation_category": None,
        "kpi_targets": {"survival_pct_min": 70.0, "geo_tagged_pct_min": 95.0},
        "active": True,
        "metadata_sections": [],
    ...
    "raj_amrit_poshan_vatika": {
        ...
        "checklist_codes": ["nutri_garden", "mgnrega_convergence"],
        "framework_profiles": ["amrit_poshan_vatika", "esg_general"],
        "convergence_allowed": ["mgnrega_convergence"],
