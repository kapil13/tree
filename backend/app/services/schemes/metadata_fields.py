...
SCHEME_METADATA_FIELDS: dict[str, list[FormField]] = {
    ...
    "township_landscape": [
        {
            "key": "society_name",
            "label": "Township / society name",
            "type": "text",
            "required": True,
            "placeholder": "Green Valley Township Phase 2",
        },
        {
            "key": "rwa_registration_id",
            "label": "RWA registration ID",
            "type": "text",
            "required": True,
            "placeholder": "RWA/MH/2024/1842",
            "help_text": "Registered residents welfare association or society registration number.",
        },
        {
            "key": "layout_plan_ref",
            "label": "Landscape layout plan reference",
            "type": "text",
            "required": False,
            "placeholder": "LDP-2025-Phase2-Avenues",
        },
        {
            "key": "developer_name",
            "label": "Developer / maintenance agency",
            "type": "text",
            "required": False,
        },
        {
            "key": "total_area_ha",
            "label": "Total landscaped area (ha)",
            "type": "number",
            "required": False,
            "min": 0.1,
        },
    ...
    "agroforestry_farm": [
        {
            "key": "farmer_beneficiary_id",
            "label": "Farmer beneficiary ID",
            "type": "text",
            "required": True,
            "placeholder": "FARM-RJ-2026-4421",
            "help_text": "Farmer ID, SHG code, or FPO membership reference.",
        },
        {
            "key": "land_record_ref",
            "label": "Land record / patta reference",
            "type": "text",
            "required": True,
            "placeholder": "Khata 142 / Khasra 88",
        },
        {
            "key": "agroforestry_plot_type",
            "label": "Agroforestry plot type",
            "type": "select",
            "required": True,
            "options": [
                {"value": "farm_forestry_strip", "label": "Farm forestry strip"},
                {"value": "boundary_plantation", "label": "Boundary plantation"},
                {"value": "silvopasture", "label": "Silvopasture"},
                {"value": "horticulture_border", "label": "Horticulture border"},
            ],
        },
        {
            "key": "gram_panchayat",
    ...
    "mh_van_mahotsav": [
        {
            "key": "miyawaki_site_id",
            "label": "Van Mahotsav / Miyawaki site ID",
            "type": "text",
            "required": True,
            "placeholder": "VM-MH-2026-1842",
        },
        {
            "key": "ulb_name",
        ...
        },
        {
            ...
            "options": [
                {"value": "school", "label": "School / campus"},
                {"value": "panchayat", "label": "Gram panchayat land"},
                {"value": "urban_forest", "label": "Urban forest patch"},
                {"value": "road_median", "label": "Road median / divider"},
            ],
        },
        {
            "key": "target_trees",
    ...
    "gj_social_forestry": [
        {
            "key": "vfc_name",
            "label": "Village forest committee",
            "type": "text",
            "required": True,
            "placeholder": "VFC Rampura",
        },
        {
            "key": "beat_officer_ref",
            "label": "Beat officer / range reference",
            "type": "text",
            "required": False,
            "placeholder": "Gandhinagar Range — Beat 4",
        },
        {
            "key": "gram_panchayat",
            "label": "Gram panchayat",
